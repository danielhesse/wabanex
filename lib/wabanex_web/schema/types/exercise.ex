defmodule WabanexWeb.Schema.Types.Exercise do
  ...
  input_object :create_exercise_input do
    ...
    field :protocol_description, non_null(:string), description: "Exercises protocol_description"
    field :youtube_video_url, non_null(:string), description: "Exercises youtube_video_url"
